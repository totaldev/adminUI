...
class ActiveForm extends Widget {
     ...
     *                               handled:
     *                               - header: string, the header HTML for the error summary. If not set, a default
     *                               prompt string will be used.
     *                               - footer: string, the footer HTML for the error summary.
     *                               The rest of the options will be rendered as the attributes of the container tag.
     *                               The values will be HTML-encoded using [[\yii\helpers\Html::encode()]]. If a value
